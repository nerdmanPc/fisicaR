...
# Verificar se a função abaixo retorna G a partir do coeficiente angular de T²(L)
pendulo.GravidadeEstimada <- function(coeficienteAngular){
  return (4 * pi*pi / coeficienteAngular)
}
...
print(pendulo.maxEcin)
print("Gravidade Estimada (m/s²)")
print(pendulo.GravidadeEstimada(pendulo.ca))
